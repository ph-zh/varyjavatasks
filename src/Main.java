/*
В прошлый раз вы описали класс конвертера валют Converter. Дополните код финансового приложения так, чтобы при запуске программы работала конвертация валют.
