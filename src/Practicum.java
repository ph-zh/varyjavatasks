...
Преобразовать текст нужно через методы substring() и indexOf(). Конструкция text.indexOf(substring) + substring.length()
вернёт индекс символа, следующего за найденной подстрокой. Начиная с этого символа, нужно вернуть остаток текста через substring().
*/
