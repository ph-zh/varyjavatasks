...
Измените имплементацию интерфейса Comparator<DateTime> — DateTimeComparator таким образом, чтобы она сравнивала
две даты по всем полям, а не только по году. Взятый в прокат фильм представлен классом RentedFilm.
