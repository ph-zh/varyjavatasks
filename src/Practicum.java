...
но для этого нужно собрать подробную аналитику по заказам. Давайте поможем ему в этом! Нужно найти самых активных клиентов — тех, кто заказывает пиццу чаще всего.
*/
...
public class Practicum {
    ...
    private void printStatistics() {
        ...
        int orderSum = 0;
        for (Integer order : orders.values()) {
            orderSum = orderSum + order;
        }
        System.out.println("Всего заказов: " + orderSum);
    }
}