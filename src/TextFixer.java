/*
Опечатки и орфографические ошибки — проклятье любых текстов. Бьёмся об заклад, в нашем курсе вам тоже попадались эти субъекты!
...
1) Исправлять кавычки "„" и "“" на "«" и "»".
2) Убирать опечатку в слове "цевилизаций" (на "цивилизаций").
3) Убирать лишние символы в начале и в конце строки.
4) Начинать строку с большой буквы. Обратите внимание, мы уже добавили в код ранее написанный вами метод String capitalize(String str).
