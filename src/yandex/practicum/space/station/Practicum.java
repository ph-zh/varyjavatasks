...
В нём есть классы всех космических модулей, включая старые блоки «Заря» и «МИР». Ваша задача — с помощью параметров,
к которым разрешён доступ, настроить безаварийную работы систем при стыковке с новым модулем «Звезда».
